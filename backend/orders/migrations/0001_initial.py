# Generated by Django 4.0.8 on 2023-03-03 19:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_UUID', shortuuid.django_fields.ShortUUIDField(alphabet='0123456789', auto_created=True, editable=False, length=10, max_length=10, prefix='', unique=True, verbose_name='UUID заказа')),
                ('user_id', models.PositiveIntegerField(editable=False)),
                ('product_list', models.TextField(blank=True, null=True, verbose_name='Список товаров')),
                ('adress', models.TextField(blank=True, max_length=150, null=True, verbose_name='Адрес клиента')),
                ('contacts', models.TextField(blank=True, max_length=15, null=True, verbose_name='Контакты клиента')),
